...
//echo '<script>console.log("'.$doctor_id.'");</script>';

//echo '<script>alert("doctor id = " + $doctor_id)</script>';
...
<!-- Move the updateStatus function outside the PHP code -->
	...
	<section id="sidebar">
		...
		<ul class="side-menu top">
			<li class="active">
				<a href="doctor_dashboard_design.php">
			...
			<li>
				<a href="specific_doctor_previous_patient.php">
		...
		<ul class="side-menu">
			...
			<li>
				<a href="doctor_logout.php" class="logout">
...
//echo '<script>console.log("'.$doctor_id.'");</script>';
            ...
            echo "
            <h2 class=\"centered-heading\" >Dr.<span>$doctor_name</span>'s :  Patient Info</h2>
            ";
?>
      ...
      <div class="table_container">
        ...
        <table class="table">
          ...
          <?php
            ...
            $query = "SELECT * FROM patient_record WHERE status='unchecked'AND doctor_to='$doctor_name'  ORDER BY date ASC";
                ...
                while($row=mysqli_fetch_array($res)){
                    ...
                    echo"
                        ...
                        <td>
                        <button class='action-btn' style='background-color: $approveColor;' onclick='updateStatus($id, \"checked\")'>checked</button>
                    </td>
        ...
        function updateStatus(id,status){
          ...
          $(document).ready(function(){
            ...
            $.ajax({
              ...
              url:'update_status_doctor_dashboard.php',
              type:'POST',
              data:{
                id:id,
                status:status
