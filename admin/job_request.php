      ...
      <div class="table_container">
        ...
        <table class="table">
          ...
          <?php
            ...
            $query = "SELECT * FROM doctor WHERE status='pending' ORDER BY date ASC";
                ...
                while($row=mysqli_fetch_array($res)){
                    ...
                    echo"
                        ...
                        <td>
                        <button class='action-btn' style='background-color: $approveColor;' onclick='updateStatus($id, \"Approve\")'>Approve</button>
            <button class='action-btn' style='background-color: $rejectColor;' onclick='updateStatus($id, \"Reject\")'>Reject</button>
                    </td>
